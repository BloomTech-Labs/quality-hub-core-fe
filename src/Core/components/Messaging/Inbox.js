...
const Inbox = () => {
  ...
  const [showList, setShowList] = useState("inbox-left-sidebar");
  const showHide = () => {
    if (showList === "inbox-left-sidebar-hidden") {
      setShowList("inbox-left-sidebar");
    } else {
      setShowList("inbox-left-sidebar-hidden");
    }
  };
  ...
  return (
    <div className="inbox-container-wrapper">
      <button className="show-hide-button" onClick={showHide}>
        Show/Hide Conversations
      </button>
      <div className="inbox-container">
        <aside className={showList}>
          ...
          {convList ? (
            <ChatList
              ...
              setTheCurrentUser={setTheCurrentUser}
            />
          ) : (
