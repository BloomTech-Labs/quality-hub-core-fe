...
const DeleteModal = ({isShowing, hide, deleteAccount}) => isShowing ? createPortal(
    
    
    <div className="modal-container">
        <div className="modal-wrapper" aria-modal aria-hidden role="dialog">
            <div className='modal-header'> 
                <img src={questionIcon}/> <h2> Do you want to delete your account?</h2>
            </div>
            ...
            <div className='modal-button-cont'>
                ...
                <button className='ok-button' onClick={deleteAccount}>OK</button>
            </div>
        </div>
    </div>
    , document.body
