...
test('form', async () => {
    ...
    rtl.fireEvent.change(rtl.getByLabelText(container, 'Password*'), {target: {value: 'chuck'}});
    rtl.fireEvent.change(rtl.getByLabelText(container, 'Email*'), {target: {value: 'chuck@quail.com'}});
    rtl.fireEvent.click(rtl.getByPlaceholderText(container, 'Industry'), {target: {value: 'Healthcare'}});
    
    rtl.fireEvent.change(rtl.getByLabelText(container, 'City*'), {target: {value: 'Toledo'}});
    rtl.fireEvent.change(rtl.getByLabelText(container, 'State/Territory*'), {target: {value: 'OH'}});
