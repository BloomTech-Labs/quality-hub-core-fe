		...
		<div className='sample-card'>
			...
			<div className='coach-text'>
				...
				<div className='coach-card-bottom'>
					<p>
						Lorem quailum birdor sit covey, flight adipiscing quailit. Vitae
						dictum covey quaility amet, sollicitudin quailcu. Lorem quailum
						birdor sit covey, flight adipiscing quailit. Vitae dictum covey
						quaility amet, sollicitudin quailcu.{' '}
					</p>
